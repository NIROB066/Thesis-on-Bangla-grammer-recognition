...
con = [
    '18 ',
    'PRONOUN->আপনি|আমাকে|আমি ',
    'ADJ->ঢাকার|প্লেনের|বিমানের|আকাশপথে|ADJ ADJ ',
    'QS->কি|কোন|কিনা|কয়টায়|কত|ADJ QS|QS ADJ ',
    'NOUN->টিকিট|দেশে|দেশ|বিমান|সময়সূচী|নভোএয়ার|ফ্লাইট|যশোর|বিমান|বাংলাদেশ|ভাড়া|ঢাকা|চট্রগ্রাম|শিডিউল ',
    'IV->যেতে|জানতে|মিস ',
    'TV->চান|ছাড়বে|চাই|করেছি ',
    'ADV->দেরিতে|গতকাল ',
    'JOIN->সেটা ',
    'VERB->জানান ',
    'PRE->এর ',
    'PREPOSITION->থেকে ',
    'PP->NOUN PREPOSITION NOUN|PP PRE ',
    'NP->PRONOUN ADJ|ADJ NOUN|NOUN IV|NOUN ADV|NP NOUN|PRONOUN NP|NOUN PRE|NOUN NP|NP NP|NOUN PREPOSITION|NOUN NOUN|PP NOUN|PRONOUN ADV|ADV NOUN ',
    'VP->NOUN TV|NP TV|NOUN VP|IV TV|ADV TV|JOIN VP|NOUN VERB|NP VERB|NP VP ',
    'NS->QS NOUN|NP QS|QS NP|PRONOUN QS|NS NS|NS NP|QS NOUN|PRONOUN NS|NS IV|NP VS|NOUN NP QS|NOUN QS|NP NS ',
    'VS->TV QS|VP QS|VS JOIN|VS IS|VS IV|VS VP|QS VP|NS TV ',
    'IS->JOIN IV ',
    'S->NS VP|NP VS|NS VS|NOUN VP|NP TV|NP NS|NP QS ',
    'S '
]
